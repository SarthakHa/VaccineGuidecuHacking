...
const InputSection= ({userID,scrollLoadingDivHandler,setDataHandler,setContriesHandler,setTBLinkHandler,setReadyToDisplayHandler, setPolicyNamesHandler,setComparisonsHandler,simulateClick})=>{
    ...
    const SouthAfricaStates = [{name: 'Eastern Cape'},{name: 'Free State'},{name: 'Gauteng'},{name: 'KwaZulu-Natal'},{name: 'Limpopo'},{name: 'Mpumalanga'},{name: 'North West'},{name: 'Northern Cape'},{name: 'Western Cape'}]
        ...
        {selectStates ?(
            ...
            {currentCountry === "United States" &&
              ...
              {currentCountry === "South Africa" &&
                 <Multiselect
                 options={SouthAfricaStates} // Options to display in the dropdown
                 //selectedValues={} // Preselected value to persist in dropdown
                 onSelect={onStatesSelect} // Function will trigger on select event
                 onRemove={onStatesRemove} // Function will trigger on remove event
                 displayValue="name" // Property name to display in the dropdown options
